  ...
  async function handlePassword(e: React.FormEvent) {
    ...
    try {
      ...
      if (totp.length > 0) {
        ...
        const { data: enrollData, error: enrollErr } = await sb.auth.mfa.enroll({ factorType: "totp", issuer: "HCMG", friendlyName: "HCMG Lift Off" });
              ...
              <form onSubmit={handlePassword}>
                <div style={{ marginBottom: 20 }}>
                  ...
                  <input
                    ...
                    style={{ width:"100%", padding:"14px 18px", borderRadius:14, border:"2px solid #E2E8F0", background:"#fff", fontSize:15, color:"#1A2B42", outline:"none", fontFamily:"inherit", boxSizing:"border-box" as const, transition:"border-color .15s" }}
                ...
                <div style={{ marginBottom: 28 }}>
                  <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:8 }}>
                    <label style={{ fontSize:11, fontWeight:700, letterSpacing:".12em", textTransform:"uppercase", color:"#1A2B42" }}>Password</label>
                    <a href="/reset-password" style={{ fontSize:12, color:"#F37021", fontWeight:700, textDecoration:"none" }}>Forgot password?</a>
                  </div>
                  <input
            ...
            <>
              ...
              <form onSubmit={handleEnrollVerify} style={{ marginTop:24 }}>
                ...
                <input
                  ...
                  autoFocus
                  style={{ width:"100%", padding:"16px", borderRadius:12, border:"2px solid #E2E8F0", background:"#fff", fontSize:28, fontWeight:700, color:"#1A2B42", letterSpacing:".35em", textAlign:"center", outline:"none", fontFamily:"inherit", transition:"border-color .15s" }}
                  onFocus={e => e.target.style.borderColor = "#F37021"}
                  onBlur={e  => e.target.style.borderColor = "#E2E8F0"}
                />
          ...
          {step === "mfa-verify" && (
            <>
              ...
              <p style={{ fontSize:13, color:"#64748B", marginBottom:32, lineHeight:1.6 }}>
                Open your authenticator app and enter the 6-digit code for <strong>HCMG Lift Off</strong>.
              </p>
