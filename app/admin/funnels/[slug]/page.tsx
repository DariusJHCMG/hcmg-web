...
import { FunnelDetailClient } from "@/app/portal/funnels/[slug]/FunnelDetailClient";
...
function calcStats(leads: Lead[]) {
  ...
  return { total, newLeads, qualified, closed, utmMap, goalMap, recentLeads };
}
...
export default async function AdminFunnelDetailPage({ params }: Props) {
  ...
  if (!profile.lo_slug) redirect("/admin/my-funnels");
