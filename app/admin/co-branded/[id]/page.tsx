...
import { CoBrandedDetail } from "@/app/portal/co-branded/[id]/CoBrandedDetail";
...
export default async function AdminCoBrandedDetailPage({ params }: Props) {
  const { id } = await params;

  const profile = await getCurrentProfile();
  if (!profile) redirect("/login");
  if (!profile.lo_slug) redirect("/admin/co-branded");
