...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/agents`, changeFrequency: "monthly", priority: 0.9, lastModified: new Date("2026-07-20") },
    { url: `${BASE}/company-partners`, changeFrequency: "monthly", priority: 0.9, lastModified: new Date("2026-07-20") },
    ...
    { url: `${BASE}/areas-we-serve`, changeFrequency: "monthly", priority: 0.9, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/nevada`,      changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/texas`,       changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/florida`,     changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/colorado`,    changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/georgia`,     changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/virginia`,    changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/maryland`,    changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
    { url: `${BASE}/areas-we-serve/california`,  changeFrequency: "monthly", priority: 0.85, lastModified: new Date("2026-07-08") },
