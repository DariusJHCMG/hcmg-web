...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/careers`, changeFrequency: "monthly", priority: 0.9, lastModified: new Date() },
    { url: `${BASE}/join`, changeFrequency: "monthly", priority: 0.8, lastModified: new Date() },
    { url: `${BASE}/careers/branch-partner`, changeFrequency: "monthly", priority: 0.7, lastModified: new Date() },
    { url: `${BASE}/careers/team-migration`, changeFrequency: "monthly", priority: 0.7, lastModified: new Date() },
    { url: `${BASE}/careers/corporate`, changeFrequency: "monthly", priority: 0.7, lastModified: new Date() },
