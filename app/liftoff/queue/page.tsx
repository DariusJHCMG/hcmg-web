...
import { canAccessLiftOffQueue, canSeeLockRequests, canSeeGeneralRequests, getLiftOffRoleLabel, canAssignRequests, canAccessHelpDeskQueue, isOpsManager } from "@/lib/auth";
...
const DEMO_REQUESTS: LiftOffRequest[] = [
  ...
  },
  {
    ...
    carried_forward_ids: null,
    loan_type: "refinance", loan_purpose: "refinance", loan_program: "conventional",
    loan_amount: 320000,
    purchase_price: null,
