...
function demoBase(overrides: Partial<LiftOffRequest>): LiftOffRequest {
  return {
    ...
    loan_type: "purchase", loan_amount: 400000, purchase_price: 450000,
...
// ── Page ───────────────────────────────────────────────────────────────────────
export default async function LiftOffPipelinePage({
  searchParams,
}: {
  ...
  if (!profile) redirect("/login?next=/liftoff/pipeline");
